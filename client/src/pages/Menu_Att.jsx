              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-purple-50 border-2 border-purple-200 rounded-xl p-4">
                    <button
                      type="button"
                      onClick={toggleMap}
                      className="w-full bg-gradient-to-r  cursor-pointer from-purple-500 to-purple-500 text-white py-3 px-6 rounded-xl font-semibold hover:from-purple-600 hover:to-teal-600 transition-all transform hover:scale-105 flex items-center justify-center gap-2"
                    >
                ...
                <div className="pt-4">
                  <button 
                    ...
                    className="w-full bg-gradient-to-r from-purple-500 cursor-pointer to-purple-400 text-white py-4 px-8 rounded-xl text-xl font-bold hover:from-red-600 hover:to-pink-600 transition-all transform hover:scale-105 shadow-lg hover:shadow-xl"
                  >
                    ยืนยันข้อมูล
                  </button>
                </div>
