...
const { get_prodact, add_prodact, delete_prodact, edit_prodact, get_product_me, get_product_id, nearby_product, get_products_by_post, get_random_products_by_post } = require('../controller/add_prodact');
